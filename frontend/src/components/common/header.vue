  ...
  <div class="relative bg-white">
    <div class="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
      <div class="flex justify-between items-center">
        ...
        <router-link
          :to="{ name: 'Dashboard' }"
          class="font-semibold text-gray-500 mx-2 text-lg cursor-pointer"
        >
          App Stocks
        </router-link>
      </div>
      <div class="md:flex-1">
        <div class="flex items-center justify-end md:ml-12">
          <div v-if="checkUserLoggedIn">
            ...
            <router-link
              :to="{ name: 'Portfolio' }"
              class="mx-1 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"
            >
              Portfolio
            </router-link>
            <router-link
