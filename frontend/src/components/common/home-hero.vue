  ...
  <div class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        <h2 class="text-xl text-indigo-600 font-semibold tracking-wide uppercase">
          App Stocks
        </h2>
        <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          A better way to manage your stocks and goals.
        </p>
        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
          A platform to manage your financial plans and align them to your ambitions
        </p>
      </div>
        ...
        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
          <div class="relative">
            ...
            <dd class="mt-2 ml-16 text-base text-gray-500">
              Allows you to create portfolios and add stocks to it.
            </dd>
          </div>
